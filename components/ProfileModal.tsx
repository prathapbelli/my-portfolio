...
const ProfileModal: React.FC<ProfileModalProps> = ({ 
  ...
  return (
    ...
    >
      <div className="bg-zinc-800 rounded-lg p-8 max-w-md w-full mx-4 relative max-h-[90vh] overflow-y-auto">
        <button
          onClick={onClose}
        ...
        <div className="text-center mb-6">
          <div className="w-24 h-24 mx-auto mb-4 rounded-lg bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
        ...
        <div className="space-y-4">
          ...
          {linkedin && (
            <a
              ...
              className="flex items-center space-x-3 p-4 bg-zinc-900 rounded-lg hover:bg-zinc-700 transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-netflix-red" fill="currentColor" viewBox="0 0 24 24">
